...
use crate::offchain_handlers::{
    add_funds, close_assigned, close_unassigned, close_unassigned_sponsored, create_bounty,
    publish_settings,
};
...
fn main() -> Worker {
    ...
    Worker::new()
        ...
        .with_request_handler("close-after-contributor", FnHandler::from(close_assigned))
    // .with_tx_handler(
    //     UtxoPattern {

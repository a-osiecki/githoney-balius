...
use crate::offchain_handlers::{add_funds, close_before_contributor, create_bounty, publish_settings};
...
fn main() -> Worker {
    ...
    Worker::new()
        ...
        .with_request_handler("close-before-contributor", FnHandler::from(close_before_contributor))
    // .with_tx_handler(
    //     UtxoPattern {
